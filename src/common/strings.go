...
func GenerateOtp() string {
	...
	mi := int(math.Pow(10, float64(cfg.Otp.Digits-1)))   // 10^d-1 100000
	ma := int(math.Pow(10, float64(cfg.Otp.Digits)) - 1) // 999999 = 1000000 - 1 (10^d) -1

	var num = rand.Intn(ma-mi) + mi
...
// ToSnakeCase : CountryId -> country_id
